...
#define NuclFSIParameterScan_cxx
...
//***********************************************************************************
void NuclFSIParameterScan::DetermineGridSize(){
...
//***********************************************************************************
void NuclFSIParameterScan::Test(){
  ...
  std::cout<<"jentry: " <<jentry << " mom: "<<mom<<" tot: "<<totfact<<" elas: "<<elafact<<" spi: "<<spifact<<" dpi: "<<dpifact<<std::endl;
    }
}
...
void NuclFSIParameterScan::InterpolateXsecs()
{

  // One for each xsec: xqe, xabs, xcx, xdcx, xhadr
  TMultiDimFit *multifit[5];
  std::vector< std::string > xsecs = {"xsecelastic","xsecspi","xsecdpi","xsecrxn","xsectotal"};
