...
## (0.1 ~ 0.5) and (1.3 ~1.7)
lfefqe = [x*grid_step_LE for x in range(1,18) if x<6 or x >12]
## (0.35 ~ 0.85) and (1.65 ~ 1.95)
lfefabs = [(x*grid_step_LE)+0.05 for x in range(3,20) if x<9 or x >15]
## (0.1 ~ 0.4) and (1.2 ~ 1.6)
lfefcx = [x*grid_step_LE for x in range(1,17) if x<5 or x >11]
## (0.2) and (1.8 ~ 2.6)
lfefinel = [x*grid_step_HE for x in range(1,14) if x<2 or x >9]
## (0.8 ~ 1.0) and (2.6 ~ 2.8)
lfefqeh = [0.8, 1.0, 2.6, 2.8]
